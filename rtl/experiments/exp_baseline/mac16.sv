...
//============================================================================
// Experiment: Baseline
// Description: Original 2-stage pipeline multiplier using behavioral * operator
// Target: Establish baseline timing (~700MHz)
//============================================================================
module mac16 (
    input  logic        clk,
    input  logic        rst_n,
    ...
    // State machine for 2-stage pipeline multiplier
