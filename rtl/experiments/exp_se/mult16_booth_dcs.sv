...
module mult16_booth_dcs (
    ...
    //=========================================================================
    // Stage 4a: LLCBC-style compression (6→4) - split CSA layer
    //=========================================================================
    wire [39:0] llcbc_s1, llcbc_c1;
    wire [39:0] llcbc_s2, llcbc_c2;
    csa #(.WIDTH(40)) u_llcbc_csa1 (
        .a(row0_s3), .b(row1_s3), .c(row2_s3),
        .sum(llcbc_s1), .carry(llcbc_c1)
    );
    csa #(.WIDTH(40)) u_llcbc_csa2 (
        .a(row3_s3), .b(row4_s3), .c(row5_s3),
        .sum(llcbc_s2), .carry(llcbc_c2)
    );

    reg [39:0] llcbc_s1_s4, llcbc_c1_s4, llcbc_s2_s4, llcbc_c2_s4;
    reg        valid_s4;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            llcbc_s1_s4 <= llcbc_s1;
            llcbc_c1_s4 <= llcbc_c1;
            llcbc_s2_s4 <= llcbc_s2;
            llcbc_c2_s4 <= llcbc_c2;
            valid_s4 <= 1'b1;
        end else begin
            valid_s4 <= 1'b0;
        end
    ...
    //=========================================================================
    // Stage 4b: 4:2 compression (4→2)
    //=========================================================================
    wire [39:0] csa6_sum, csa6_carry;
    compressor_4to2_array #(.WIDTH(40)) u_llcbc_comp42 (
        .a(llcbc_s1_s4),
        .b(llcbc_s2_s4),
        .c({llcbc_c1_s4[38:0], 1'b0}),
        .d({llcbc_c2_s4[38:0], 1'b0}),
        .sum(csa6_sum),
        .carry(csa6_carry)
    );
