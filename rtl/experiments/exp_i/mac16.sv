`timescale 1ns/1ps
//============================================================================
// Experiment I: Operand Isolation + Valid-Gated Pipeline Registers
// 
// Key Optimizations:
//   1. Operand isolation (from Exp H)
//   2. Valid-based gating for ALL pipeline registers in multiplier
//   3. Simple accumulator logic
//
// This is a refined version of Exp H with better power gating
//============================================================================
module mac16 (
    input  logic        clk,
    input  logic        rst_n,
    ...
    // Isolated multiplier inputs - only update once per 16 cycles
    ...
    // Structural Booth multiplier with valid-gated registers
    mult16_booth_gated u_mult (
        .clk(clk),
        .rst_n(rst_n),
        .a(mult_in_a),
        .b(mult_in_b),
