`timescale 1ns/1ps
//============================================================================
// Experiment L: MAC16 with 6-Stage Deep Pipeline Multiplier
// 
// Key Changes from Exp K:
//   1. Multiplier latency: 5 stages → 6 stages (split CPA)
//   2. Added S_MULT_WAIT state waits for valid_out from 6-stage multiplier
//   3. Target: TT @ 1.3GHz+ for better SS Corner headroom
//
// Pipeline latency: 6 cycles for multiplication
// Total latency: 16 (input) + 6 (mult) + 1 (add) + 24 (output) = 47 cycles
//============================================================================
module mac16 (
    input  logic        clk,
    input  logic        rst_n,
