`timescale 1ns/1ps
//============================================================================
// Experiment RA: Full MUX-Based Compression Architecture
// 
// Key Optimization: Replace ALL CSAs with MUX-based versions
// - Stage 1: Booth Encoding
// - Stage 2: PPG
// - Stage 3: MUX-CSA Layers 1+2 + Feedback (all MUX-based)
// - Stage 4: MUX 4:2 Compressor + MUX CSA
// - Stage 5: Output
//
// Expected: ~10-15% improvement from MUX optimization on critical path
//============================================================================
module mult16_booth_dcs (
    ...
    // MUX-CSA Feedback Injection
    wire [39:0] csa5_sum, csa5_carry;
    csa_mux #(.WIDTH(40)) u_csa5 (
        .a(acc_sum_s2),
        .b(acc_carry_s2),
        .c(csa3_sum),
        .sum(csa5_sum), 
