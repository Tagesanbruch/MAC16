`timescale 1ns/1ps
//============================================================================
// Experiment SH: DCS Booth Multiplier with PPG-Only Stage + LLCBC Compression
//
// Based on exp_nc stage partitioning:
// - Stage 1: Booth Encoding
// - Stage 2: PPG Only (8 PPs registered)
// - Stage 3: CSA Layer 1 (8→6) + CSA Layer 2 (6→4) + Feedback merged (5 rows)
// - Stage 4: LLCBC-style compression (5→2 by padding one zero row)
// - Stage 5: Output
//============================================================================
module mult16_booth_dcs (
    ...
    //=========================================================================
    // Stage 3: CSA Layer 1 (8→6) + CSA Layer 2 (6→4) + Feedback Merge (5 rows)
    //=========================================================================
    ...
    // Merge feedback here: acc_sum + acc_carry + csa3_sum
    ...
    // Pipeline register - Stage 3 (5 rows)
    ...
    //=========================================================================
    // Stage 4: LLCBC-style compression (5→2 by padding a zero row)
    //=========================================================================
