`timescale 1ns/1ps
//============================================================================
// Experiment SB: DCS Booth Multiplier with 6:3 Counter (Stage4)
// 
...
// - Stage 4: 6:3 Counter + CSA (shifted) to 2 rows.
// - Stage 5: Output.
//
...
module mult16_booth_dcs (
    ...
    // Keep feedback as separate rows for 6:3 counter in Stage 4.
    ...
    //=========================================================================
    // Stage 4: 6:3 Counter + CSA (shifted) (6→2)
    //=========================================================================
    wire [39:0] cnt_sum, cnt_carry1, cnt_carry2;
    counter_6to3_array #(.WIDTH(40)) u_cnt63 (
        .a(row0_s3),
        .b(row1_s3),
        .c(row2_s3),
        .d(row3_s3),
