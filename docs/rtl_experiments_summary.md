...
- exp_h：仅看到 [mac16-1000MHz/mac16.rpt](syn/yosys-syn-exp_h-2026-01-26_19-39-51/mac16-1000MHz/mac16.rpt#L1-L12)，WNS -0.067ns，对应 937.170MHz。
- exp_i：存在两个更晚的 STA 报告，结果分化明显：
  - [mac16_2026-01-26T11_46_31.rpt](syn/yosys-syn-exp_i-2026-01-26_19-40-06/mac16-1000MHz_sta_2026-01-26T11_46_31/mac16_2026-01-26T11_46_31.rpt#L1-L12)：WNS +0.030ns，1031.144MHz；
  - [mac16_2026-01-26T11_46_35.rpt](syn/yosys-syn-exp_i-2026-01-26_19-40-06/mac16-1000MHz_sta_2026-01-26T11_46_35/mac16_2026-01-26T11_46_35.rpt#L1-L12)：WNS -0.786ns，560.057MHz。
  - 说明：很可能为不同 corner/约束或模型设置导致差异，应以目标 corner 为准。
- exp_j：仅看到 [mac16-1000MHz/mac16.rpt](syn/yosys-syn-exp_j-2026-01-26_19-40-23/mac16-1000MHz/mac16.rpt#L1-L12)，WNS -0.147ns，对应 871.982MHz。
...
### 5.26 exp_sh / exp_si / exp_sj（S 系列三代：方向 4.5）

- **exp_sh**：与 exp_nc 的“PPG 单独成级”思路融合版本。
  - 较新 STA：WNS -0.185ns，844.095MHz。
  - 参考：[mac16_2026-02-02T18_18_12.rpt](syn/yosys-syn-exp_sh-2026-02-03_02-17-45/mac16-1000MHz_sta_2026-02-02T18_18_12/mac16_2026-02-02T18_18_12.rpt#L1-L12)
- **exp_si**：PPG 拆分版（基于 exp_sf 思路）。
  - 较新 STA：WNS -0.219ns，820.419MHz。
  - 参考：[mac16_2026-02-02T18_19_07.rpt](syn/yosys-syn-exp_si-2026-02-03_02-18-49/mac16-1000MHz_sta_2026-02-02T18_19_07/mac16_2026-02-02T18_19_07.rpt#L1-L12)
- **exp_sj**：VMA 改为 Kogge‑Stone。
  - 较新 STA：WNS -0.224ns，817.128MHz。
  - 参考：[mac16_2026-02-02T18_19_41.rpt](syn/yosys-syn-exp_sj-2026-02-03_02-19-23/mac16-1000MHz_sta_2026-02-02T18_19_41/mac16_2026-02-02T18_19_41.rpt#L1-L12)

**结论**：三者均未超过 exp_sd；较早报告中出现更高频率，说明存在 corner/约束差异。

### 5.27 exp_ta / exp_tb（双/三向量冗余累加探索）

- **exp_ta**：基于 exp_sd，Stage4 改为 CSA‑only 6→2 压缩（双向量冗余）。
  - STA（较新）：WNS -0.367ns，731.633MHz。
  - Power/Area：2.673e-03 W / 8334.48。
  - 参考：[mac16_2026-02-02T18_37_11.rpt](syn/yosys-syn-exp_ta-2026-02-03_02-36-44/mac16-1000MHz_sta_2026-02-02T18_37_11/mac16_2026-02-02T18_37_11.rpt#L1-L12)
- **exp_tb**：基于 exp_sd，保留 3 向量反馈（sum/carry/extra），输出阶段用 CPA 合并三向量。
  - STA（较新）：WNS -0.530ns，653.685MHz。
  - Power/Area：4.032e-03 W / 9451.68。
  - 参考：[mac16_2026-02-02T18_38_05.rpt](syn/yosys-syn-exp_tb-2026-02-03_02-37-39/mac16-1000MHz_sta_2026-02-02T18_38_05/mac16_2026-02-02T18_38_05.rpt#L1-L12)

**结论**：双/三向量冗余在当前约束下进一步拉低频率，且 exp_tb 功耗/面积显著上升。
...
## 7.1 S 系列面积/功耗（mac16-1000MHz）

> 面积来自 `synth_stat.txt` 的 `Chip area`；功耗来自 `mac16.pwr` 的 `Total Power`。

| 实验 | Area | Total Power (W) |
| --- | ---: | ---: |
| exp_sa | 8265.880000 | 2.534e-03 |
| exp_sb | 8787.800000 | 3.095e-03 |
| exp_sc | 8837.640000 | 2.639e-03 |
| exp_sd | 8426.600000 | 2.440e-03 |
| exp_se | 9042.600000 | 2.546e-03 |
| exp_sf | 9799.160000 | 3.058e-03 |
| exp_sg | 8384.320000 | 1.441e-02 |
| exp_sh | 8292.200000 | 3.371e-03 |
| exp_si | 9799.160000 | 2.765e-03 |
| exp_sj | 8476.440000 | 2.833e-03 |
| exp_ta | 8334.480000 | 2.673e-03 |
| exp_tb | 9451.680000 | 4.032e-03 |

观察：exp_sd 仍是 S 系列里面积/功耗均较稳的折中点；exp_sg 的功耗显著偏高，需要确认切换活动与估算条件；exp_tb 功耗/面积明显上升。
...
- **5:2 压缩器 / (6,3)/(7,3) 计数器/LLCBC**：已在 S 系列完成初步落地（exp_sa/sb/sc/sd），但尚未带来频率突破。
...
- 若继续以频率为第一目标：
  - **5:2/6:3/7:3/LLCBC 已试**（S 系列），但频率未超过 exp_sd；后续需要结合更明确的 PPG/对齐重定时（如 NC 的 S2-only PPG）才能验证收益。
  - **Radix‑8 / Radix‑4+8 混合 Booth**：适合与 DCS 主线结合，但会显著改动 PPG 与对齐路径；若与 exp_sd 结合，需重新设计 PPG 与 LLCBC 输入排列，复杂度较高。
  - **Vedic 乘法 + 前缀加法器**：更接近分解乘法路线，和 exp_sd 的 Booth/LLCBC 不同体系，融合价值有限，建议独立验证。
  - **双/三向量冗余累加**：理论上可与 exp_sd 的 LLCBC 压缩链结合（扩展到三向量 CSA/计数器），但会提升面积/功耗和路由复杂度；若以 1GHz 为目标，建议在 exp_nc/exp_ng 主线先验证其收益再考虑融合。
- 若继续保留 5 周期延迟约束：
...
- **实现路径建议**（面向 1GHz）：
  - 继续以 exp_nc/exp_ng 为主线做 PPG/对齐重定时与控制网扇出优化；
  - exp_sd 可作为“压缩链改造”的备选，但需先解决 PPG/对齐与控制网引入的路径开销，否则收益不明显。
